...
class ReceiptVouchersInfo implements UseCase<SimpleResponseModel, Params> {
  final AddbondOfArrestRepository? repository;

  ReceiptVouchersInfo({this.repository});

  @override
  Future<Either<Failure, SimpleResponseModel>> call(Params params) async {
    return await repository!.ReceiptVouchersInfo(params.vinfo);
  }
}
